"""
HuggingFace embeddings module.
Uses sentence-transformers models (runs locally, no API key needed).

Popular in ML education and research. Great for learning and portfolios.
"""
